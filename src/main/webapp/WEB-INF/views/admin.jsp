		...
		<c:if test="${category eq 'summary'}">
			<div class="data">
				...
				<div class="data-summary">
					...
					<dl>
						<dt style="color: orange;">개발 게시판</dt>
						<dd>${countStudy}</dd>
					</dl>
					<dl>
						<dt style="color: green;">일상 게시판</dt>
						<dd>${countDiary}</dd>
					</dl>
	    ...
	    chartDrow : function(){
	        ...
	        function drawDashboard() {
	          ...
	          for (var i = 0; i < queryObjectLen; i++) {
	              ...
	              var study = queryObject.boardList[i].study;
	              var diary = queryObject.boardList[i].diary;
	              ...
	              dataRow = [new Date(create_date.substring(0, 4), create_date.substring(5, 7) - 1, create_date.substring(8, 10)), 
	            	  none + study + diary +  none, study, diary, ];
	              data.addRow(dataRow);
	          }
