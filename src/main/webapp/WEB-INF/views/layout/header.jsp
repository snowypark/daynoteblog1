...
<body>
	<nav class="navbar navbar-expand-md bg-dark navbar-dark justify-content-between">
        ...
        <ul class="category-ul">
			...
			<li class="category-li" onclick="location.href='/board?category=study'"><i class="fa-solid fa-link"></i>&nbsp; 개발</li>
			<li class="category-li" onclick="location.href='/board?category=diary'"><i class="fa-solid fa-link"></i>&nbsp; 일기</li>
		</ul>
		</div>
